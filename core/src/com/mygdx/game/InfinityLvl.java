...
public class InfinityLvl implements Screen {
    ...
    public InfinityLvl(final Drop gam) {
        ...
        playGame = new String[]{"cheese", "cheese", "mousetrap","mousetrap","mousetrap","cheese",
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, "Cheese collected " + count, 350, 460);
        ...
        if(TimeUtils.nanoTime() - lastDropTime > 800000000 && !(success)) spawnRaindrop(playGame[MathUtils.random(0,6)]);
        ...
        while(iter.hasNext()) {
            ...
            if(raindrop.y + 32 < 0){
                iter.remove();
                if (raindrop.type.equals("cheese")){
                    errSound.play();
                }
            }
            if(raindrop.overlaps(bucket)) {
                if (raindrop.type.equals("mousetrap")){
                    afkSound.stop();
